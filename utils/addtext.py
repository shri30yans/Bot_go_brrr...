...
def generate_meme(im,top_text,bottom_text='', font_path='./Fonts/impact.ttf', font_size=8,stroke_width=5):
    # load image
    #im = image_path
...
def add_text(im,top_text,bottom_text,x1,y1,x2,y2,font_path='./Fonts/impact.ttf', font_size=8,stroke_width=5):
    # load image
    #im = image_path
    #im = add_margin(im, 200, 20, 20, 20,colour)
