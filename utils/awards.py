...
awards_list={"Wholesome_Award":Award(name="Wholesome",reaction_id=config.reddit_award_wholesome,
                    karma_given_to_receiver=5,karma_given_to_giver=random.randint(2,10),
