...
class EmbedHelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        embed = discord.Embed(
            title="**Bot Commands**",
            description='[Invite Link](https://ptb.discord.com/api/oauth2/authorize?client_id=800371434785865789&permissions=1543896182&scope=bot "Invite me.") | [Support Server](https://discord.gg/cDk6pZYQWC "Join our support server for help") | [Source](https://github.com/shri30yans/Bot_go_brrr... "My source code") ',
