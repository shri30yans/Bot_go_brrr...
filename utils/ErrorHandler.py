...
class CommandErrorHandler(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        ...
        async def CooldownFunction(ctx):
            ...
            embed.add_field(
                name="Slow down there, Romeo :rose: :race_car:",
                value=f"Please wait before using {ctx.command} command again.\nYou can use this command in **{retry_after}** again.",
                inline=False,
            )
            embed.set_footer(
        ...
        if isinstance(error, commands.errors.MissingRequiredArgument):
            ...
            embed.add_field(
                ...
                value=f"**Command help:** \n{ctx.command.help}\nFormat: `{ctx.command.qualified_name} {ctx.command.signature}`",
                inline=False,
            )
            embed.set_footer(
                icon_url=ctx.author.avatar_url,
            ...
            embed = discord.Embed(
                title="⚠️ | The checks failed", color=random.choice(colourlist)
            )
            embed.add_field(
                name="This action has been temporarily paused.",
                value=f"Error: {error}",
                inline=False,
            )
            embed.set_footer(
            ...
            embed = discord.Embed(
                title="⚠️ | Maintenance mode", color=random.choice(colourlist)
            )
            embed.add_field(
                name="This action has been temporarily paused.",
                value=f"Please try again later.",
                inline=False,
            )
            embed.set_footer(
                icon_url=ctx.author.avatar_url,
            ...
            embed = discord.Embed(
                title="⚠️ | Starboard Error", color=random.choice(colourlist)
            )
            embed.add_field(
                name="Starboard is not enabled in this server.",
                value=f"To enable the starboard set it up using the setup subcommand.",
                inline=False,
            )
            embed.set_footer(
                icon_url=ctx.author.avatar_url,
            ...
            embed = discord.Embed(
                title="⚠️ | Setup Command Error", color=random.choice(colourlist)
            )
            embed.add_field(
                name="Starboard has already been set in this server.",
                value=f"The Setup command cannot be run multiple times.",
                inline=False,
            )
            embed.set_footer(
                icon_url=ctx.author.avatar_url,
            ...
            embed = discord.Embed(
                title="⚠️ | Not Approved Server", color=random.choice(colourlist)
            )
            embed.add_field(
                name="This action has been disabled for this server.",
                value=f"Please try contacting the admins.",
                inline=False,
            )
            embed.set_footer(
                icon_url=ctx.author.avatar_url,
