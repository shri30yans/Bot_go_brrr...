...
STARTUP_COGS = [
    ...
    "cogs.StarboardCog",
    "cogs.OwnerCog",
    "core.ImportantFunctions",
    "core.StarboardFunctions",
    "core.UserDatabaseFunctions",
    "jishaku",
    "utils.ErrorHandler",
]
...
cog_emojis = {
    "utility": "<:utility:878323140793630770>",
...
# images
spin_the_wheel_images = {
    "Free_Credits": ["https://i.imgur.com/Xx3W9QO.jpg"],
    "Deduct_Credits": ["https://i.imgur.com/oNBioRL.gif"],
    "Free_Karma": [
        "https://i.imgur.com/yvZC5MZ.jpg",
        "https://i.imgur.com/SibjIPI.gif",
    ],
